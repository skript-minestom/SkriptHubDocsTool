...
1. Download the Skript Hub Docs Tool from [here](https://github.com/skript-minestom/SkriptHubDocsTool/releases) and place it into your development servers ```/Skript/addons/``` folder. **DO NOT USE THIS PLUGIN IN PRODUCTION!**
2. Run your server.
